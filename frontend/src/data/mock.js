...
export const personalInfo = {
  ...
  linkedin: "https://www.linkedin.com/in/arpit-lal-23092003j/",
  github: "https://github.com/Akkissss23",
  bio: "Passionate undergraduate Electrical Engineer with hands-on expertise in Rest API , FullStack Dev., Testing ,Machine Learning , AI and LLM API. Proven track record designing and executing robust end-to-end ML/DL ,pipelines for NLP, text classification, and pattern recognition tasks. Experienced competitive programmer seeking high-impact AI/ML Engineer / QA / SDE roles.",
